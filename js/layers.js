...
=======
        33: {
            ...
            description() {
                return "Memory" + ((hasUpgrade('light', 23) && (player['awaken'].current == 'light' || player['awaken'].awakened.includes('light'))) ? " and Fragment" : "") + " gain is massively boosted, but " + ((hasMilestone('kou', 2) || (player['awaken'].current == 'light' || player['awaken'].awakened.includes('light'))) ? "" : "with Fragment gain massively decreased and ") + "Fragments & Memories are set to 1."
            },
        ...
        34: {
            title: "Conclusion",
            description() {
                if (hasAchievement('a', 23)) return "The Memory softcap starts later, but Fragments & Memories are set to 1.";
                if (hasAchievement('a', 22)) return "Useless and Fragments & Memories are set to 1.";
                return "Unlock two new layers, but with Memory gain decreased and Fragments & Memories are set to 1.";
            },
        ...
        41: {
            ...
            fullDisplay() {
                if (hasAchievement('a', 21)) return "<b>Eternal Core</b></br>A core build up by massive Memories and a little Lightness & Darkness. It contains nearly endless energy.";
                return "<b>Build Up The Core.</b></br>Unlock two new layers, but sacrifice all your progress.</br></br>Cost: 1e23 Memories</br>65 Light Tachyons</br>65 Dark Matters"
            },
...
=======
            ...
            effectDescription() {
                ...
                if (player.awaken.current != this.layer) str = str + ' & Light Upgrades return their cost by total num of Achievements you have.';
                else str = str + "."
                return str;
            },
>>>>>>> Stashed changes
...
=======
        ...
        32: { //title: "Moments of Lives",
            ...
            fullDisplay() {
                let str = "<b>Moments of Lives</b><br>"
...
=======
            ...
            effectDescription() {
                let str = "This Layer is no longer hidden";
                if (player.awaken.current != this.layer) str = str + ' & Dark Upgrades return their cost by total num of Achievements you have.';
                else str = str + "."
                return str;
            },
>>>>>>> Stashed changes
